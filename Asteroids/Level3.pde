...
class AsteroidsLevel3 extends GameLevel 
{
  ...
  int numLives;
  long time, timeLimit = 120000; /* TIME LIMIT FUNCTIONALITY */
  int maxLives = 2;
  ...
  void start()
  {
    ...
    asteroids.add(new BigAsteroid(applet, 200, 500, 0, 0.02, 27.5, PI*.5));
    asteroids.add(new BigAsteroid(applet, 500, 200, 1, -0.01, 27.5, PI*1));
    asteroids.add(new BigAsteroid(applet, 100, 300, 2, 0.01, 27.5, PI*1.7));
    asteroids.add(new BigAsteroid(applet, 500, 600, 0, -0.02, 27.5, PI*1.3));
    asteroids.add(new BigAsteroid(applet, 300, 300, 2, 0.01, 27.5, PI*1.4));
  ...
  private void addSmallAsteroids(GameObject go) 
  {
    ...
    //speed of the small asteroids increased to 1.25x of the first two levels
    asteroids.add(new SmallAsteroid(applet, xpos, ypos, 0, 0.02, 55, PI*.5));
    asteroids.add(new SmallAsteroid(applet, xpos, ypos, 1, -0.01, 55, PI*1));
    asteroids.add(new SmallAsteroid(applet, xpos, ypos, 2, 0.01, 55, PI*1.7));
  }
}
